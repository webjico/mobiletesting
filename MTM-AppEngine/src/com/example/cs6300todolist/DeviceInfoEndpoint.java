...
import com.example.cs6300todolist.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "example.com", ownerName = "example.com", packagePath = "cs6300todolist"))
